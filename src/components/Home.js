    ...
    return (
        <div>
            <div className="grid relative grid-cols-2">
                <div className="px-5 py-10 sm:px-10 sm:py-20 bg-skin_light gap-3 flex flex-col justify-center items-start">
                    <h1 className="font-bold text-xl">Gift and more..</h1>
                    ...
                    <a className="bg-skin_dark py-2 px-6 text-white rounded-lg" href="">SHOP NOW</a>
                </div>
                <div className="">
                    <img className="w-full h-auto" src="/assets/images/pexels-cup-of-couple.jpg" alt="" srcSet="" />
                </div>
                <div className="absolute bottom-0 left-1/3 text-white py-5 px-10 bg-footer_gray flex justify-center items-center space-x-4">
                    <span>01</span>
                    <div className="w-40 h-1 bg-skin_dark"></div>
                    <i className='bx bxs-chevron-left text-2xl text-skin_dark' ></i>
                    <i className='bx bxs-chevron-right text-2xl text-skin_dark'></i>
                </div>
            </div>
            {/* <!-- Categories --> */}
            <Categories />
            <div className="w-4/5 mx-auto my-10">
                <div className="p-10 bg-white_dark">
                    <h1 className="text-center font-bold text-2xl py-2">Our Features</h1>
